...
import * as data15Jan from './data-15-JAN-2026';
import {
  calculateDrainDate,
...
export const availableDataSets = [
  { id: '15-JAN-2026', label: 'January 15, 2026', value: '15-JAN-2026', module: data15Jan },
...
/**
 * Default to the most recent data set (January 15, 2026)
 */
let currentDataSetId = '15-JAN-2026';
...
const getCurrentDataModule = () => {
  ...
  return dataset?.module || data15Jan;
};
